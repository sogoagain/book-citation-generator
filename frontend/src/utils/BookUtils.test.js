...
describe('BookUtils', () => {
  describe('getFormattedWriters', () => {
    ...
    describe('when the number of main writers has not been exceeded', () => {
      beforeEach(() => {
        writers = ['임작가']
      })
    ...
    describe('when the number of main writers has been exceeded', () => {
      beforeEach(() => {
        writers = ['임작가', '김작가']
      })
  ...
  describe('getMLACitationNotation', () => {
    ...
    describe('with 1 authors', () => {
      ...
      it('returns citation notation', () => {
        ...
        expect(citation).toBe(
          '샘 라이트스톤. 프로그래머로 사는 법. 한빛미디어, 2012.'
        )
      })
    })

    describe('with 2 authors', () => {
      beforeEach(() => {
        book = {
    ...
    describe('with 3 or more authors', () => {
      beforeEach(() => {
        book = {
      ...
      it('returns citation notation', () => {
        ...
        expect(citation).toBe(
          '김성완 외. 게임 프로그래머로 산다는 것(사람과 프로그래머). 로드북, 2016.'
        )
      })
    })
  })
